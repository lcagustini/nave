...
bool rayIntersectsTriangle(struct vector rayOrigin, struct vector rayVector, int model, struct vector vertex0, struct vector vertex1, struct vector vertex2, struct vector *outIntersectionPoint) {
